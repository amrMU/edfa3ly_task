    ...
    <div class="content-wrapper">
        ...
        <div class="page-header page-header-default">
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    <li><a href="{{URL::to(LaravelLocalization::getCurrentLocale().'admin/orders')}}"><i class="icon-home2 position-left"></i> @lang('home.home')</a></li>
                                ...
                                @if($orders->count() > 0)
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                @include('dashboard.orders.actions')

                                            </td>
                                        </tr>
                                    @endforeach
                                <tr>
                                    <th colspan="8" class="text-center">{{$orders->links()}}</th>
                                </tr>
                                @else
                                <tr>
