...
<div id="open_cart{{@$product->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <form action="{{url(LaravelLocalization::getCurrentLocale()).'/add/cart'}}" method="post">
            @csrf
        <!-- Modal content-->
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="form-group has-feedback has-feedback-left">
                            ...
                            <div class="col-lg-9">
                                <input type="number" name="quantity" id="quantity" class="form-control input-xlg" placeholder="1" value="{{Request::old('quantity')}}" min="1">
